...
import { FaCaretDown, FaBars, FaBell, FaKeyboard, FaSpinner, FaUser, FaSignOutAlt } from "react-icons/fa";
...
const TopNavbar = ({
  ...
  useEffect(() => {
    ...
    return () => window.removeEventListener(PROFILE_IMAGE_UPDATED, handleProfileImageUpdate);
  }, []);
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            >
              ...
              <FaCaretDown className={`text-gray-700 transition-transform duration-200 ${isDropdownOpen ? 'rotate-180' : ''}`} />
            </button>
          ...
          <div className="bg-white rounded-lg p-6 max-w-md w-full">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center p-2 hover:bg-gray-50 rounded">
                ...
                <kbd className="px-2 py-1 bg-gray-100 rounded text-sm">Alt + N</kbd>
              </div>
              <div className="flex justify-between items-center p-2 hover:bg-gray-50 rounded">
                <span>Profile</span>
                <kbd className="px-2 py-1 bg-gray-100 rounded text-sm">Alt + P</kbd>
              </div>
              <div className="flex justify-between items-center p-2 hover:bg-gray-50 rounded">
                <span>Shortcuts</span>
                <kbd className="px-2 py-1 bg-gray-100 rounded text-sm">Alt + K</kbd>
              </div>
              <div className="flex justify-between items-center p-2 hover:bg-gray-50 rounded">
