  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (customUserResponse.status === 200 && userInfoResponse.status === 200) {
        // Fetch updated data
        const updatedResponse = await axiosInstance.get('/api/user-parent/current-parent/');
            ...
            <div className="border-b border-stroke py-4 px-7 dark:border-strokedark">
              <div className="flex items-center justify-between">
                ...
                <span className="inline-flex items-center justify-center rounded-full bg-blue-100 px-3 py-1 text-xs  truncate font-medium text-blue-800 dark:bg-blue-900 dark:text-blue-200">
                  {studentInfo.length} {studentInfo.length === 1 ? 'Student' : 'Students'}
                </span>
              </div>
            </div>
            <div className="p-7">
              {studentInfo.length > 0 ? (
                          ...
                          <div className="h-16 w-16 flex-shrink-0 rounded-full bg-blue-100 flex items-center justify-center overflow-hidden">
                            {student.user_info?.profile_image ? (
                              <img
                                ...
                                onError={(e) => {
                                  console.error('Student image failed to load:', e);
                          ...
                          <div className="flex-grow min-w-0">
                            ...
                            <div className="mt-2 sm:mt-3 flex flex-col space-y-2">
                              <div className="flex items-center text-sm sm:text-base lg:text-lg text-gray-500 dark:text-gray-400">
                                ...
                                <span className="font-medium whitespace-nowrap  truncate">{student.grade_level}</span>
                              </div>
                ...
                <div className="flex flex-col items-center justify-center py-12">
                  ...
                  <h3 className="mt-4 text-lg font-medium text-gray-900 dark:text-white">No Students Connected</h3>
                  <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Contact your school administrator to connect students to your account.
                  </p>
                </div>
              )}
            </div>
