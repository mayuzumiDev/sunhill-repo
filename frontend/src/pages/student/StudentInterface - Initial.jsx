  ...
  const tutorialSteps = [
    {
      ...
      text: "Get ready for a fun learning adventure on your Sunhill LMS!",
      target: ".container",
    },
    {
      title: "Start Learning",
      text: "Click here to begin your daily learning activities!",
      target: "#start-class-button",
    },
    {
      title: "Watch Videos",
      text: "Explore educational videos that teach you new things!",
      target: "#watch-video-button",
    },
    {
      title: "Play Games",
      text: "Enjoy interactive games that help you learn!",
      target: "#play-game-button",
    },
    {
      title: "Chat",
      text: "Connect with your classmates and share what you've learned!",
      target: "#chat-button",
    },
    {
      title: "To-Do List",
      text: "Keep track of your tasks and assignments here!",
      target: "#todo-list",
    },
    {
      title: "Your Progress",
      text: "View your learning progress and achievements!",
      target: "#progress-chart",
    },
    {
      title: "Subjects",
      text: "Explore different subjects and topics here!",
      target: ".grid-cols-2.sm\\:grid-cols-4",
    },
  ];
  ...
  useEffect(() => {
    if (showWelcome) {
      const welcomeMessage =
        "Welcome to Sunhill, young learners! Get ready for an amazing, out-of-this-world learning adventure!";
        ...
        {showDashboard ? (
          <>
            ...
            >
              ...
              >
                Welcome to {student.grade} Adventure!
              </h1>
              <p
                className="text-lg sm:text-xl mt-2"
                style={{ fontFamily: "Comic Sans MS, cursive" }}
              >
                Section {student.section} Explorers
              </p>
            </motion.header>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              ...
              >
                <h2
                  className="text-2xl font-bold mb-4 text-center text-orange-600"
                  style={{ fontFamily: "Comic Sans MS, cursive" }}
                >
